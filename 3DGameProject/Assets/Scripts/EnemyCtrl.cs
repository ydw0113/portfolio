...
public class EnemyCtrl : MonoBehaviour {
	...
	void dropItem()
	{
		...
		Vector3 a = new Vector3 (this.transform.position.x, this.transform.position.y+0.8f, this.transform.position.z);
		Instantiate (dropItem, a, Quaternion.identity);
	}
