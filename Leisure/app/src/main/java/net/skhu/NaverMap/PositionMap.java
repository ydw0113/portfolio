...
public class PositionMap extends NMapActivity {
    private  int c= 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.acitivity_positionmap);
        init();
        ListView listView = (ListView) findViewById(R.id.seoulList);

        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if(position ==0) {
                    mMapController.setMapCenter(new NGeoPoint(127.072951 ,37.644640), 11);     //Default Data
                }else if(position ==1){
                    mMapController.setMapCenter(new NGeoPoint(126.880522 ,37.584367), 11);     //Default Data
                }else if(position ==2){
                    mMapController.setMapCenter(new NGeoPoint(127.135454, 37.500494), 11);     //Default Data
                }else if(position ==3){
                    mMapController.setMapCenter(new NGeoPoint(127.148695, 37.554916), 11);     //Default Data
                }
    ...
    private void init(){
        ...
        mMapController.setMapCenter(new NGeoPoint(127.135454,37.500494), 6);     //Default Data
    ...
    private void setMarker(){
        ...
        // set POI data
        NMapPOIdata poiData = new NMapPOIdata(5, nMapResourceProvider);
        poiData.beginPOIdata(0);
        poiData.addPOIitem(127.072951 ,37.644640 ,"동천재활체육센터", markerId, 0 );
        poiData.addPOIitem(126.880522 ,37.584367,"마포푸르메스포츠센터", markerId, 1 );
        poiData.addPOIitem(127.135454, 37.500494, "서울곰두리체육관", markerId, 2);
        poiData.addPOIitem(127.148695, 37.554916,"서울수중재활체육센터", markerId, 3 );
