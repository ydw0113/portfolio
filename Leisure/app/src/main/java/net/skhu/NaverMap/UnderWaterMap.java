...
public class UnderWaterMap extends NMapActivity {
    private  int c= 0;
    private final String  TAG = "UnderWaterMap";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_undermap);
// Here, thisActivity is the current activity
        Button button2 = (Button)findViewById(R.id.btn_position2);
    ...
    public void button3_clicked(View button) {
        Button button3 = (Button)findViewById(R.id.btn_position);
        Button button2 = (Button)findViewById(R.id.btn_position2);
        if(c ==0) {
            startMyLocation();
    ...
    private void setMarker(){
        ...
        poiData.addPOIitem(127.148695, 37.554916, "서울수중재활체육센터", markerId, 0);
        poiData.endPOIdata();
