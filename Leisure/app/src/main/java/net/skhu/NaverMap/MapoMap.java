...
public class MapoMap extends NMapActivity {
    private  int c= 0;
    private final String  TAG = "MapoMap";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mapomap);
    ...
    private void setMarker(){
        ...
        poiData.addPOIitem(126.880522 ,37.584367, "서울푸르메스포츠센터", markerId, 0);
        poiData.endPOIdata();
