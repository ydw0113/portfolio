...
public class basic4 : MonoBehaviour {
	...
	void Start () {
		...
		this.boom = GameObject.Find ("boom");
		this.boom2 = GameObject.Find ("boom2");
	...
	void Update () {
		...
		if (Input.GetKeyDown (KeyCode.Space)) {
			GameObject go = Instantiate (arrowPre3) as GameObject;
	...
	void OnCollisionEnter2D(Collision2D other){
		...
		}/* else if (other.gameObject.Equals (boom)) {
			SceneManager.LoadScene ("basic4");
		}	else if (other.gameObject.Equals (boom2)) {
			SceneManager.LoadScene ("basic4");
		}*/
